...
![](assets/big/leo.svg){.absolute width=600px height=580px left=600px top=-200px}
...
![](assets/big/scorpio.svg){.absolute width=600px height=580px left=600px top=-200px}
...
![](assets/big/aries.svg){.absolute width=600px height=580px left=600px top=-200px}
...
![](assets/big/virgo.svg){.absolute width=600px height=580px left=600px top=-200px}
...
![](assets/big/capricorn.svg){.absolute width=600px height=580px left=600px top=-200px}
...
![](assets/medium/bottle-butterflies.svg){.absolute width=553.524px height=576.587px left=597px top=45px}
